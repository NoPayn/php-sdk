...
<head>
  ...
  <title>NoPayn SDK — Merchant Demo</title>
  <style>
...
<body>
  <div class="card">
    ...
    <h1>NoPayn Checkout</h1>
    <p class="desc">This merchant demo uses the <strong>nopayn/sdk</strong> PHP package to create a payment and redirect to the Hosted Payment Page.</p>

    <div class="product">
      <div class="product-icon">&#9889;</div>
      <div class="product-info">
        <div class="product-name">NoPayn Test Product</div>
        <div class="product-price" id="price-display">&euro;9.95</div>
      </div>
    </div>
    ...
    <form method="POST" action="/pay">
      <div class="form-row">
        <div class="form-group">
          ...
          <input type="number" id="amount" name="amount" value="9.95" min="0.01" step="0.01" />
        </div>
        <div class="form-group">
      ...
      <button type="submit" class="btn">Pay with NoPayn</button>
    </form>

    <p class="powered">Powered by <a href="https://costplus.io" target="_blank">Cost+</a> &middot; <a href="https://github.com/NoPayn/php-sdk" target="_blank">View SDK on GitHub</a></p>
  </div>

  <script>
    const symbols = { EUR: '\u20AC', GBP: '\u00A3', USD: '$', NOK: 'kr', SEK: 'kr', DKK: 'kr' };
